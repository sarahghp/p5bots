...
amdclean['src_client_special_methods'] = function (require, src_client_socket_utils, src_client_serial, src_client_variable_resistor) {
  var utils = src_client_socket_utils;
  var special = {
      button: function (pin) {
        pin.direction = 'input';
  ...
  return special;
}({}, amdclean['src_client_socket_utils'], amdclean['src_client_serial'], amdclean['src_client_variable_resistor']);
