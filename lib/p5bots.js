/*! p5.sensors.js v0.0.0 2015-07-27 */
...
amdclean['src_client_socket_utils'] = function (require) {
  ...
  var utils = {
      ...
      constructFuncs: function (pin, mode) {
        var mode = mode || pin.mode, timeout;
...
amdclean['src_client_special_methods_index'] = function (require, src_client_button, src_client_led, src_client_motor, src_client_rgb, src_client_serial, src_client_servo, src_client_temp, src_client_variable_resistor) {
  var special = {
  ...
  return special;
}({}, amdclean['src_client_button'], amdclean['src_client_led'], amdclean['src_client_motor'], amdclean['src_client_rgb'], amdclean['src_client_serial'], amdclean['src_client_servo'], amdclean['src_client_temp'], amdclean['src_client_variable_resistor']);
